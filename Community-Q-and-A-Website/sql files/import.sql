...
--Posts
COPY "posts" FROM './data/Posts.csv' WITH (FORMAT csv);
...
COPY "post_links_dummy" FROM './data/PostLinks.csv' WITH (FORMAT csv);
...
COPY "votes_dummy" FROM './data/Votes.csv' WITH (FORMAT csv);
INSERT INTO votes 
...
COPY "badges_dummy" FROM './data/Badges.csv' WITH (FORMAT csv);
INSERT INTO badges 
...
--Tags
COPY "tags" FROM './data/Tags.csv' WITH (FORMAT csv);
